...
public enum MessageErrorEnum {
	...
	CAMPAING_NON_FINISHED_CANNOT_UPDATE_DONATION("Campanha não finalizada, não é possível atualizar uma doação."),
	...
	CAMPAIGN_DONATION_UPDATE_WITHOUT_DATA("Não é possível atualizar uma doação com nenhum valor novo.");
